...
log "Ensuring subnet '$YC_SUBNET_NAME' is absent (to recreate fresh)..."
delete_subnet_by_name "$YC_SUBNET_NAME" || true

log "Ensuring network '$YC_NETWORK_NAME' is absent (to recreate fresh)..."
delete_network_by_name "$YC_NETWORK_NAME" || true
...
log "Network '$YC_NETWORK_NAME' and subnet '$YC_SUBNET_NAME' created."
